    ...
    public partial class ucKoppen : UserControl
    {
        ...
        private void FindIklimForValues()
        {
            ...
            while ((feature = updateCursor.NextRow()) != null)
            {
                ...
                queryFilterSic.WhereClause = "CombineSic  = " + feature.get_Value(sicField);
                ICursor updateCursorSic = vatSic.Search(queryFilter, false);
                ...
                queryFilterYag.WhereClause = "CombineYag  = " + feature.get_Value(yagField);
                ICursor updateCursorYag = vatYag.Search(queryFilter, false);
